...
CREATE TABLE IF NOT EXISTS `INPUTEVENTS_MV`(
    ...
    `PATIENTWEIGHT` DOUBLE(10,3) NOT NULL,
    `TOTALAMOUNT` DOUBLE(10,3) ,
    ...
    `ORIGINALAMOUNT` DOUBLE(10,3) NOT NULL,
    `ORIGINALRATE` DOUBLE(10,3) NOT NULL,
    PRIMARY KEY (`ROW_ID`),
    FOREIGN KEY (`SUBJECT_ID`) REFERENCES `PATIENTS`(`SUBJECT_ID`),
    FOREIGN KEY (`HADM_ID`) REFERENCES `ADMISSIONS`(`HADM_ID`),
    FOREIGN KEY (`ICUSTAY_ID`) REFERENCES `ICUSTAYS`(`ICUSTAY_ID`),
...
CREATE TABLE IF NOT EXISTS `MICROBIOLOGYEVENTS`(
    ...
    `DILUTION_VALUE` DOUBLE(10,2) ,
    `INTERPRETATION` VARCHAR(5) ,
    PRIMARY KEY (`ROW_ID`),
    FOREIGN KEY (`SUBJECT_ID`) REFERENCES `PATIENTS`(`SUBJECT_ID`),
    FOREIGN KEY (`HADM_ID`) REFERENCES `ADMISSIONS`(`HADM_ID`),
    FOREIGN KEY (`SPEC_ITEMID`) REFERENCES `D_ITEMS`(`ITEMID`),
    FOREIGN KEY (`ORG_ITEMID`) REFERENCES `D_ITEMS`(`ITEMID`),
    FOREIGN KEY (`AB_ITEMID`) REFERENCES `D_ITEMS`(`ITEMID`)
);
